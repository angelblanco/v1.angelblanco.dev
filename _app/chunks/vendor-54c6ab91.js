function B(){}const Ta=t=>t;function nn(t,n){for(const e in n)t[e]=n[e];return t}function _e(t){return t()}function jn(){return Object.create(null)}function dt(t){t.forEach(_e)}function Ce(t){return typeof t=="function"}function Oa(t,n){return t!=t?n==n:t!==n||t&&typeof t=="object"||typeof t=="function"}let Tt;function Ys(t,n){return Tt||(Tt=document.createElement("a")),Tt.href=n,t===Tt.href}function Ea(t){return Object.keys(t).length===0}function Se(t,...n){if(t==null)return B;const e=t.subscribe(...n);return e.unsubscribe?()=>e.unsubscribe():e}function Rs(t,n,e){t.$$.on_destroy.push(Se(n,e))}function Fs(t,n,e,a){if(t){const r=Ae(t,n,e,a);return t[0](r)}}function Ae(t,n,e,a){return t[1]&&a?nn(e.ctx.slice(),t[1](a(n))):e.ctx}function Hs(t,n,e,a){if(t[2]&&a){const r=t[2](a(e));if(n.dirty===void 0)return r;if(typeof r=="object"){const o=[],i=Math.max(n.dirty.length,r.length);for(let s=0;s<i;s+=1)o[s]=n.dirty[s]|r[s];return o}return n.dirty|r}return n.dirty}function Us(t,n,e,a,r,o){if(r){const i=Ae(n,e,a,o);t.p(i,r)}}function Vs(t){if(t.ctx.length>32){const n=[],e=t.ctx.length/32;for(let a=0;a<e;a++)n[a]=-1;return n}return-1}function Ws(t){return t==null?"":t}const $e=typeof window!="undefined";let La=$e?()=>window.performance.now():()=>Date.now(),Me=$e?t=>requestAnimationFrame(t):B;const ut=new Set;function Te(t){ut.forEach(n=>{n.c(t)||(ut.delete(n),n.f())}),ut.size!==0&&Me(Te)}function Na(t){let n;return ut.size===0&&Me(Te),{promise:new Promise(e=>{ut.add(n={c:t,f:e})}),abort(){ut.delete(n)}}}let Ht=!1;function Ia(){Ht=!0}function za(){Ht=!1}function Pa(t,n,e,a){for(;t<n;){const r=t+(n-t>>1);e(r)<=a?t=r+1:n=r}return t}function Da(t){if(t.hydrate_init)return;t.hydrate_init=!0;let n=t.childNodes;if(t.nodeName==="HEAD"){const f=[];for(let c=0;c<n.length;c++){const u=n[c];u.claim_order!==void 0&&f.push(u)}n=f}const e=new Int32Array(n.length+1),a=new Int32Array(n.length);e[0]=-1;let r=0;for(let f=0;f<n.length;f++){const c=n[f].claim_order,u=(r>0&&n[e[r]].claim_order<=c?r+1:Pa(1,r,p=>n[e[p]].claim_order,c))-1;a[f]=e[u]+1;const l=u+1;e[l]=f,r=Math.max(l,r)}const o=[],i=[];let s=n.length-1;for(let f=e[r]+1;f!=0;f=a[f-1]){for(o.push(n[f-1]);s>=f;s--)i.push(n[s]);s--}for(;s>=0;s--)i.push(n[s]);o.reverse(),i.sort((f,c)=>f.claim_order-c.claim_order);for(let f=0,c=0;f<i.length;f++){for(;c<o.length&&i[f].claim_order>=o[c].claim_order;)c++;const u=c<o.length?o[c]:null;t.insertBefore(i[f],u)}}function ja(t,n){if(Ht){for(Da(t),(t.actual_end_child===void 0||t.actual_end_child!==null&&t.actual_end_child.parentElement!==t)&&(t.actual_end_child=t.firstChild);t.actual_end_child!==null&&t.actual_end_child.claim_order===void 0;)t.actual_end_child=t.actual_end_child.nextSibling;n!==t.actual_end_child?(n.claim_order!==void 0||n.parentNode!==t)&&t.insertBefore(n,t.actual_end_child):t.actual_end_child=n.nextSibling}else(n.parentNode!==t||n.nextSibling!==null)&&t.appendChild(n)}function Ya(t,n,e){t.insertBefore(n,e||null)}function Ra(t,n,e){Ht&&!e?ja(t,n):(n.parentNode!==t||n.nextSibling!=e)&&t.insertBefore(n,e||null)}function Dt(t){t.parentNode.removeChild(t)}function Gs(t,n){for(let e=0;e<t.length;e+=1)t[e]&&t[e].d(n)}function Oe(t){return document.createElement(t)}function yn(t){return document.createTextNode(t)}function Bs(){return yn(" ")}function qs(){return yn("")}function Xs(t,n,e,a){return t.addEventListener(n,e,a),()=>t.removeEventListener(n,e,a)}function Js(t,n,e){e==null?t.removeAttribute(n):t.getAttribute(n)!==e&&t.setAttribute(n,e)}function Fa(t){return Array.from(t.childNodes)}function Ee(t){t.claim_info===void 0&&(t.claim_info={last_index:0,total_claimed:0})}function Le(t,n,e,a,r=!1){Ee(t);const o=(()=>{for(let i=t.claim_info.last_index;i<t.length;i++){const s=t[i];if(n(s)){const f=e(s);return f===void 0?t.splice(i,1):t[i]=f,r||(t.claim_info.last_index=i),s}}for(let i=t.claim_info.last_index-1;i>=0;i--){const s=t[i];if(n(s)){const f=e(s);return f===void 0?t.splice(i,1):t[i]=f,r?f===void 0&&t.claim_info.last_index--:t.claim_info.last_index=i,s}}return a()})();return o.claim_order=t.claim_info.total_claimed,t.claim_info.total_claimed+=1,o}function Ha(t,n,e,a){return Le(t,r=>r.nodeName===n,r=>{const o=[];for(let i=0;i<r.attributes.length;i++){const s=r.attributes[i];e[s.name]||o.push(s.name)}o.forEach(i=>r.removeAttribute(i))},()=>a(n))}function Zs(t,n,e){return Ha(t,n,e,Oe)}function Ua(t,n){return Le(t,e=>e.nodeType===3,e=>{const a=""+n;if(e.data.startsWith(a)){if(e.data.length!==a.length)return e.splitText(a.length)}else e.data=a},()=>yn(n),!0)}function Ks(t){return Ua(t," ")}function Yn(t,n,e){for(let a=e;a<t.length;a+=1){const r=t[a];if(r.nodeType===8&&r.textContent.trim()===n)return a}return t.length}function Qs(t){const n=Yn(t,"HTML_TAG_START",0),e=Yn(t,"HTML_TAG_END",n);if(n===e)return new Rn;Ee(t);const a=t.splice(n,e-n+1);Dt(a[0]),Dt(a[a.length-1]);const r=a.slice(1,a.length-1);for(const o of r)o.claim_order=t.claim_info.total_claimed,t.claim_info.total_claimed+=1;return new Rn(r)}function tf(t,n){n=""+n,t.wholeText!==n&&(t.data=n)}function nf(t,n,e,a){e===null?t.style.removeProperty(n):t.style.setProperty(n,e,a?"important":"")}function ef(t,n,e){t.classList[e?"add":"remove"](n)}function af(t,n=document.body){return Array.from(n.querySelectorAll(t))}class Va{constructor(){this.e=this.n=null}c(n){this.h(n)}m(n,e,a=null){this.e||(this.e=Oe(e.nodeName),this.t=e,this.c(n)),this.i(a)}h(n){this.e.innerHTML=n,this.n=Array.from(this.e.childNodes)}i(n){for(let e=0;e<this.n.length;e+=1)Ya(this.t,this.n[e],n)}p(n){this.d(),this.h(n),this.i(this.a)}d(){this.n.forEach(Dt)}}class Rn extends Va{constructor(n){super();this.e=this.n=null,this.l=n}c(n){this.l?this.n=this.l:super.c(n)}i(n){for(let e=0;e<this.n.length;e+=1)Ra(this.t,this.n[e],n)}}let _t;function xt(t){_t=t}function St(){if(!_t)throw new Error("Function called outside component initialization");return _t}function rf(t){St().$$.on_mount.push(t)}function of(t){St().$$.after_update.push(t)}function sf(t){St().$$.on_destroy.push(t)}function ff(t,n){St().$$.context.set(t,n)}function cf(t){return St().$$.context.get(t)}const bt=[],Fn=[],Lt=[],Hn=[],Ne=Promise.resolve();let en=!1;function Ie(){en||(en=!0,Ne.then(ze))}function lf(){return Ie(),Ne}function an(t){Lt.push(t)}const Jt=new Set;let Ot=0;function ze(){const t=_t;do{for(;Ot<bt.length;){const n=bt[Ot];Ot++,xt(n),Wa(n.$$)}for(xt(null),bt.length=0,Ot=0;Fn.length;)Fn.pop()();for(let n=0;n<Lt.length;n+=1){const e=Lt[n];Jt.has(e)||(Jt.add(e),e())}Lt.length=0}while(bt.length);for(;Hn.length;)Hn.pop()();en=!1,Jt.clear(),xt(t)}function Wa(t){if(t.fragment!==null){t.update(),dt(t.before_update);const n=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,n),t.after_update.forEach(an)}}const Nt=new Set;let at;function uf(){at={r:0,c:[],p:at}}function mf(){at.r||dt(at.c),at=at.p}function Ga(t,n){t&&t.i&&(Nt.delete(t),t.i(n))}function df(t,n,e,a){if(t&&t.o){if(Nt.has(t))return;Nt.add(t),at.c.push(()=>{Nt.delete(t),a&&(e&&t.d(1),a())}),t.o(n)}}function vf(t,n){const e={},a={},r={$$scope:1};let o=t.length;for(;o--;){const i=t[o],s=n[o];if(s){for(const f in i)f in s||(a[f]=1);for(const f in s)r[f]||(e[f]=s[f],r[f]=1);t[o]=s}else for(const f in i)r[f]=1}for(const i in a)i in e||(e[i]=void 0);return e}function hf(t){return typeof t=="object"&&t!==null?t:{}}function gf(t){t&&t.c()}function pf(t,n){t&&t.l(n)}function Ba(t,n,e,a){const{fragment:r,on_mount:o,on_destroy:i,after_update:s}=t.$$;r&&r.m(n,e),a||an(()=>{const f=o.map(_e).filter(Ce);i?i.push(...f):dt(f),t.$$.on_mount=[]}),s.forEach(an)}function qa(t,n){const e=t.$$;e.fragment!==null&&(dt(e.on_destroy),e.fragment&&e.fragment.d(n),e.on_destroy=e.fragment=null,e.ctx=[])}function Xa(t,n){t.$$.dirty[0]===-1&&(bt.push(t),Ie(),t.$$.dirty.fill(0)),t.$$.dirty[n/31|0]|=1<<n%31}function bf(t,n,e,a,r,o,i,s=[-1]){const f=_t;xt(t);const c=t.$$={fragment:null,ctx:null,props:o,update:B,not_equal:r,bound:jn(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(n.context||(f?f.$$.context:[])),callbacks:jn(),dirty:s,skip_bound:!1,root:n.target||f.$$.root};i&&i(c.root);let u=!1;if(c.ctx=e?e(t,n.props||{},(l,p,...y)=>{const w=y.length?y[0]:p;return c.ctx&&r(c.ctx[l],c.ctx[l]=w)&&(!c.skip_bound&&c.bound[l]&&c.bound[l](w),u&&Xa(t,l)),p}):[],c.update(),u=!0,dt(c.before_update),c.fragment=a?a(c.ctx):!1,n.target){if(n.hydrate){Ia();const l=Fa(n.target);c.fragment&&c.fragment.l(l),l.forEach(Dt)}else c.fragment&&c.fragment.c();n.intro&&Ga(t.$$.fragment),Ba(t,n.target,n.anchor,n.customElement),za(),ze()}xt(f)}class yf{$destroy(){qa(this,1),this.$destroy=B}$on(n,e){const a=this.$$.callbacks[n]||(this.$$.callbacks[n]=[]);return a.push(e),()=>{const r=a.indexOf(e);r!==-1&&a.splice(r,1)}}$set(n){this.$$set&&!Ea(n)&&(this.$$.skip_bound=!0,this.$$set(n),this.$$.skip_bound=!1)}}const ft=[];function Ja(t,n){return{subscribe:Pe(t,n).subscribe}}function Pe(t,n=B){let e;const a=new Set;function r(s){if(Oa(t,s)&&(t=s,e)){const f=!ft.length;for(const c of a)c[1](),ft.push(c,t);if(f){for(let c=0;c<ft.length;c+=2)ft[c][0](ft[c+1]);ft.length=0}}}function o(s){r(s(t))}function i(s,f=B){const c=[s,f];return a.add(c),a.size===1&&(e=n(r)||B),s(t),()=>{a.delete(c),a.size===0&&(e(),e=null)}}return{set:r,update:o,subscribe:i}}function xf(t,n,e){const a=!Array.isArray(t),r=a?[t]:t,o=n.length<2;return Ja(e,i=>{let s=!1;const f=[];let c=0,u=B;const l=()=>{if(c)return;u();const y=n(a?f[0]:f,i);o?i(y):u=Ce(y)?y:B},p=r.map((y,w)=>Se(y,m=>{f[w]=m,c&=~(1<<w),s&&l()},()=>{c|=1<<w}));return s=!0,l(),function(){dt(p),u()}})}/*!
