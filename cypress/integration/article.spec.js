describe('Article', () => {
    const sharedTests = () => {
        ...
        it('contains newsletter subscribe', () => {
            ...
            cy.get('.box.tiny-letter').get('form').should(form => expect(form.attr('action')).to.contain('https://tinyletter.com'));
        });
    };
    ...
    context('Welcome article', () => {
        ...
        it('contains title', () => cy.get('.title.is-1').contains('Welcome to my personal blog'));
    ...
    context('Simple Svelte back to top component', () => {
        ...
        it('Simple Svelte back to top component', () => cy.get('.title.is-1').contains('Simple Svelte back to top component'));
