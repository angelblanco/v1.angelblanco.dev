describe('Main page', () => {
  ...
  it('contains a primary notification that navigates to all articles', () => {
    ...
    notification.get('a').contains('latest articles').click();
  ...
  [
    ...
    it(`should go to the tag ${item.contains} when clicking`, () => {
      cy.get('.home-quick-tags a').contains(item.contains).click();
  ...
  it('navigates to all articles when clicking "See all articles"', () => {
    cy.get('.button.all-articles').contains('See all the articles').click();
